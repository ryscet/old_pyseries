...
if on_rtd:
    MOCK_MODULES = ['sphinx_paramlinks','seaborn','pyseries.Analysis', 'pyseries.Analysis.Anova', 'pyseries.Preprocessing','pyseries.Preprocessing.PrepareData', 'pyseries.LoadingData.Read_edf',  'pyseries','obspy.signal.filter','sphinx_bootstrap_theme','tabulate','sklearn','sklearn.cluster', 'sklearn.metrics','sklearn.decomposition','scipy.sparse', 'numpy', 'scipy','scipy.stats','scipy.io', 'matplotlib', 'matplotlib.pyplot','matplotlib.cm', 'scipy.interpolate', 'numpydoc', 'glob', 'pandas', 'deepdish']
